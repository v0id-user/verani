 Contributing to Verani

First off — thank you for taking the time to contribute 🤍
Verani is built in the open, and we welcome improvements, bug reports, and new ideas.
...
5. Open a **Pull Request** targeting the `canary` branch.
...
- Review and refactor AI-assisted code to match the **Verani style** (clarity, type safety, and minimal complexity).
...
Thanks again for helping improve Verani
